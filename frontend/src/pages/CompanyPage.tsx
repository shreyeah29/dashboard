            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-black mb-2">Innovation Focus</h3>
                ...
                <motion.div
                  ...
                  className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300"
                >
                  <div className="w-16 h-16 bg-edicius-navy rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              {projects.map((project) => (
                <motion.div key={project._id} variants={itemVariants}>
                  <Link to={`/project/${project.slug}`}>
                    <Card className="h-full hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 group cursor-pointer border-0 shadow-lg">
                      <div className="relative overflow-hidden rounded-t-xl">
                        {project.bannerImage ? (
                          ...
                          <div className="w-full h-56 bg-gradient-to-br from-edicius-navy via-edicius-red to-edicius-gold flex items-center justify-center">
                      ...
                      <CardContent className="p-8">
                        <h3 className="text-2xl font-bold text-black mb-4 group-hover:text-edicius-gold transition-colors duration-200">
                          {project.name}
                        </h3>
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                          <span className="text-lg font-semibold text-edicius-gold group-hover:text-edicius-red transition-colors duration-200">
